...
VALUES ('005', 'Webhook Support - HTTP callouts, retry logic, monitoring', CURRENT_TIMESTAMP)
...
BEGIN
    ...
    RAISE NOTICE '📡 Added: Webhook Support (4.2)';
    RAISE NOTICE '✓ Created tables: rule_webhooks, rule_webhook_secrets, rule_webhook_calls, rule_webhook_call_history';
    RAISE NOTICE '✓ Functions: register, call, enqueue, retry, cleanup';
    RAISE NOTICE '✓ Views: webhook_status_summary, webhook_recent_failures, webhook_performance_stats';
    RAISE NOTICE '';
    RAISE NOTICE '⚠️  Note: Actual HTTP calls require:';
    RAISE NOTICE '   - Option 1: Install http extension (CREATE EXTENSION http;)';
    RAISE NOTICE '   - Option 2: Use external worker to process webhook queue';
    RAISE NOTICE '';
    RAISE NOTICE '📖 See documentation for usage examples';
END $$;
